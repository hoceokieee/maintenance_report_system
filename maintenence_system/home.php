...
// For customer role, show their submitted reports
if ($user_role === 'customer') {
    // Get total reports count for this customer
    ...
    // For staff roles (admin/manager/technician), show all reports
    $total_query = "SELECT COUNT(*) as total FROM REPORT";
    $stmt = $conn->prepare($total_query);
    $stmt->execute();
    $total_result = $stmt->get_result();
    $total_reports = $total_result->fetch_assoc()['total'];
